...
namespace Lykke.Service.EthereumClassicApi.Repositories.Strategies
{
        ...
        where T : AzureTableEntity, new()
    {
        ...
        public async Task<(IEnumerable<T> Entities, string ContinuationToken)> ExecuteAsync(int take,
        ...
        public async Task<(IEnumerable<T> Entities, string ContinuationToken)> ExecuteAsync(Func<T, bool> filter,
            int task, string continuationToken)
        {
            //TODO: Add pagination
        ...
        public async Task<(IEnumerable<T> Entities, string ContinuationToken)> ExecuteAsync(string partitionKey,
